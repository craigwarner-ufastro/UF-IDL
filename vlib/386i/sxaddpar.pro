Pro sxaddpar, Header, Name, Value, Comment, Location, format=format
;+
; NAME:
;    SXADDPAR
; PURPOSE:
...
;-
if n_params(0) lt 3 then begin             ;Need at least 3 parameters
      print,'Calling Sequence - Sxaddpar,Header,Name,[Value,Comment,Postion]
      return
endif
;
...
if n_params(0) gt 4 then begin
      LOC = strupcase(location)
      while strlen(loc) lt 8 do loc=loc+' '
end else LOC = 'END     '
;
if n_params(0) lt 4 then comment=''      ;Is comment field specified?
;
